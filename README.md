...
This example shows how to use a human-in-the-loop (HITL) to selectivly insert rows into an n8n Data Table. For Chat node following the AI Agent output to work, you must set the 1st chat trigger node's parameter option for 'Response Mode' to 'Using Response Nodes':
